...
public class VituralConsole {

	private static Logger log = Logger.getLogger(VituralConsole.class);
	...
	public static String[] linuxPromptRegEx = new String[] { "~]#", "~#", "#",
			":~#", "/$", ">" };
	public static String[] routerPromptRegEx = new String[] { "#",};
	...
	public VituralConsole(String ip, int port, String user, String password) {
		this.ip = ip;
		this.port = port;
		this.user = user;
	...
	public boolean executeCommands(String[] commands) {
		...
		System.out.println("the expect is build up!");
		...
		String[] regEx = routerPromptRegEx;
	...
	private boolean isSuccess(List<Match> objPattern, String strCommandPattern) {
		try {
			...
			if (!isFailed) {
				...
				System.out.println("send the command to expect :"+ strCommandPattern);
				
				expect.send(strCommandPattern);
				expect.send("\n");
				
				System.out.println("excute the command: " + strCommandPattern +" resutlt is true");
				return true;										
			}
